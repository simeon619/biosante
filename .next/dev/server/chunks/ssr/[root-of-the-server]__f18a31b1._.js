...
const CartDrawer = ()=>{
    ...
    // Logic: 
    // If items >= 2: Free Delivery
    // If items < 2: Delivery 1000 FCFA (default)
    // Note: 4% Wave discount is applied at payment, not in cart
    const isEligibleForFreeDelivery = totalItems >= 2;
    const deliveryFee = isEligibleForFreeDelivery ? 0 : 1000;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f18a31b1._.js.map