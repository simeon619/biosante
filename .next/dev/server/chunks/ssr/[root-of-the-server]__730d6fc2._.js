...
function ProductsPage() {
    const [dynamicProducts, setDynamicProducts] = useState(__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$products$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["products"]);
    useEffect(()=>{
        const fetchProducts = async ()=>{
            try {
                ...
                if (response.ok) {
                    ...
                    const merged = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$products$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["products"].map((sp)=>{
                        const dbp = dbProducts.find((p)=>p.id === sp.id);
                        if (dbp) {
                            return {
                                ...sp,
                                name: dbp.name,
                    ...
                    const activeProducts = merged.filter((sp)=>dbProducts.some((p)=>p.id === sp.id));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__730d6fc2._.js.map