...
"[project]/app/(store)/produits/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        const fetchProducts = async ()=>{
            try {
                ...
                if (response.ok) {
                    ...
                    console.log('Fetched products from DB (List):', dbProducts.map((p)=>({
                            id: p.id,
                            image: p.image
                        })));
...
//# sourceMappingURL=_0ddf3419._.js.map