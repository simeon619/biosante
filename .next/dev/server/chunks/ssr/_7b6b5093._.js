...
function AdminSettingsPage() {
    ...
    const fetchSettings = async ()=>{
        ...
        try {
            ...
            const response = await fetch('http://localhost:3333/api/admin/settings', {
                headers: {
    ...
    const saveSettings = async ()=>{
        ...
        try {
            ...
            const response = await fetch('http://localhost:3333/api/admin/settings/bulk', {
                method: 'POST',
                headers: {
...
//# sourceMappingURL=_7b6b5093._.js.map