...
function ProductEditor({ productId, isNew }) {
    ...
    const { isLoading: isLoadingProduct } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'admin',
            'products',
            productId
        ...
        queryFn: {
            "ProductEditor.useQuery": async ()=>{
                const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/admin/products/${productId}`, {
                    cache: 'no-store'
                });
    ...
    const handleFileUpload = async (e, slot)=>{
        ...
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/admin/uploads/image`, {
                method: 'POST',
                body: fd
            });
    ...
    const saveMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "ProductEditor.useMutation[saveMutation]": async (payload)=>{
                const url = isNew ? `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/admin/products` : `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/admin/products/${productId}`;
        ...
        }["ProductEditor.useMutation[saveMutation]"],
        onSuccess: {
            "ProductEditor.useMutation[saveMutation]": ()=>{
        ...
        onError: {
            "ProductEditor.useMutation[saveMutation]": (error)=>{
                alert(error.message);
            }
        }["ProductEditor.useMutation[saveMutation]"]
    });
...
_s(ProductEditor, "TZqrtaZQIY0/7h4B74zAGtWQp0s=", false, function() {
    return [
...
//# sourceMappingURL=_1b3ad099._.js.map