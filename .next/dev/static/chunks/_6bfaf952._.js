...
"[project]/lib/fpixel.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const FB_PIXEL_ID = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_FACEBOOK_PIXEL_ID;
...
const SettingsContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])({
    settings: __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultSettings"],
    isLoaded: false
});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsProvider.useEffect": ()=>{
            async function loadSettings() {
                try {
                    const fetched = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPublicSettings"])();
                    setSettings(fetched);
                } catch (error) {
...
_s(SettingsProvider, "Z9CmumK4AVSpm6h7Tb9U/Z6DOgs=");
_c = SettingsProvider;
const useSettings = ()=>{
    _s1();
...
const CartProvider = ({ children })=>{
    ...
    const { settings } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SettingsContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSettings"])();
    ...
    const addToCart = (product)=>{
        ...
        if (settings.fb_pixel_id) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fpixel$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["event"]('AddToCart', {
                content_ids: [
                    product.id
                ],
...
_s(CartProvider, "FWFfVxUO921GnFK9fcQMLXvJAwY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SettingsContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSettings"]
    ];
});
_c = CartProvider;
const useCart = ()=>{
...
const API_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || 'https://api-biosante.sublymus.com';
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const api = {
     ...
     */ estimateDelivery: async (address, cartTotal)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/deliveries/estimate`, {
                address,
                cartTotal
            });
     ...
     */ createDelivery: async (data)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/deliveries/create`, data);
            return response.data;
        } catch (error) {
     ...
     */ initiatePayment: async (data)=>{
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/payments/initiate`, data, {
            headers: userId ? {
                'X-User-Id': userId
            } : {}
        });
     ...
     */ verifyPayment: async (paymentId, orderId)=>{
        ...
        const url = paymentId ? `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/payments/verify/${paymentId}` : `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/payments/verify`;
     ...
     */ async uploadProof (orderId, file) {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/payments/proof`, formData, {
            headers: {
    ...
    async submitReference (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/payments/submit-reference`, data);
        return response.data;
    },
    // --- Authentication & Account ---
    async register (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/auth/register`, data);
        return response.data;
    },
    async login (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/auth/login`, data);
        return response.data;
    },
    async sendOtp (phone) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/auth/send-otp`, {
            phone
        });
        return response.data;
    },
    async verifyOtp (phone, otp) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/auth/verify-otp`, {
            phone,
            otp
        });
        return response.data;
    ...
    async getMe (userId) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/auth/me`, {
            headers: {
                'X-User-Id': userId
            }
        });
    ...
    async getOrders (userId) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/auth/orders`, {
            headers: {
                'X-User-Id': userId
            }
        });
    ...
    async addAddress (userId, data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/auth/addresses`, data, {
            headers: {
                'X-User-Id': userId
            }
        });
    ...
    async updateAddress (userId, addressId, data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/auth/addresses/${addressId}`, data, {
            headers: {
                'X-User-Id': userId
            }
        });
    ...
    async setDefaultAddress (userId, addressId) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/auth/addresses/${addressId}/default`, {}, {
            headers: {
                'X-User-Id': userId
            }
        });
    ...
    async requestPhoneChangeOtp (userId, newPhone) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/otp/request-phone-change`, {
            userId,
            newPhone
        });
        return response.data;
    ...
    async verifyPhoneChangeOtp (userId, otp, newPhone) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/otp/verify-phone-change`, {
            userId,
            otp,
            newPhone
        });
...
const FacebookPixel = ({ pixelId })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FacebookPixel.useEffect": ()=>{
            if (!pixelId) return;
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fpixel$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pageview"](pixelId);
        }
    }["FacebookPixel.useEffect"], [
        pathname,
        searchParams,
...
_s(QueryProvider, "4ZfnkjRQ1XxOXOk09n0Jsr2vmyM=");
_c = QueryProvider;
var _c;
...
//# sourceMappingURL=_6bfaf952._.js.map