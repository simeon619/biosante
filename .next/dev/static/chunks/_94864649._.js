                ...
                "Home.useEffect.fetchProducts": async ()=>{
                    try {
                        ...
                        if (response.ok) {
                            ...
                            console.log('Fetched products from DB:', dbProducts.map({
                                "Home.useEffect.fetchProducts": (p)=>({
                                        id: p.id,
                                        image: p.image
                                    })
                            }["Home.useEffect.fetchProducts"]));
                            const activeProducts = dbProducts.map({
                                "Home.useEffect.fetchProducts.activeProducts": (dbp)=>{
                                    const sp = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].find({
                                        "Home.useEffect.fetchProducts.activeProducts.sp": (p)=>p.id === dbp.id
                                    }["Home.useEffect.fetchProducts.activeProducts.sp"]);
                            ...
                            }["Home.useEffect.fetchProducts.activeProducts"]);
...
_s(Home, "5LSH+8tMHAit3v4kGAtfMPUESKI=", false, function() {
    return [
...
//# sourceMappingURL=_94864649._.js.map